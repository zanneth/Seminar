...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('assignments_submission', 'comments',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'SubmissionFile.comments'
        db.delete_column('assignments_submissionfile', 'comments')


    def backwards(self, orm):
        # Deleting field 'Submission.comments'
        db.delete_column('assignments_submission', 'comments')

        # Adding field 'SubmissionFile.comments'
        db.add_column('assignments_submissionfile', 'comments',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
