...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('assignments_assignmentgroup', (
            ...
            ('weight', self.gf('django.db.models.fields.FloatField')(default=0.0, blank=True)),
        ))
        ...
        db.create_table('assignments_assignment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assignments', to=orm['core.Course'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('description_html', self.gf('django.db.models.fields.TextField')()),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assignments', null=True, to=orm['assignments.AssignmentGroup'])),
            ...
            ('allows_submissions', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('assignments', ['Assignment'])

        # Adding model 'Asset'
        db.create_table('assignments_asset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('assignment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assets', to=orm['assignments.Assignment'])),
        ))
        db.send_create_signal('assignments', ['Asset'])

        # Adding model 'Submission'
        db.create_table('assignments_submission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assignment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='submissions', to=orm['assignments.Assignment'])),
            ('submitter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='submissions', to=orm['core.UserProfile'])),
        ...
        db.send_create_signal('assignments', ['Submission'])

        # Adding model 'SubmissionFile'
        db.create_table('assignments_submissionfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('comments', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', to=orm['assignments.Submission'])),
        ))
        db.send_create_signal('assignments', ['SubmissionFile'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('assignments_asset')

        # Deleting model 'Submission'
        db.delete_table('assignments_submission')

        # Deleting model 'SubmissionFile'
        db.delete_table('assignments_submissionfile')
