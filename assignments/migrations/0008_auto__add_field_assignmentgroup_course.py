...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssignmentGroup.course'
        db.add_column('assignments_assignmentgroup', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='assignment_groups', to=orm['core.Course']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssignmentGroup.course'
        db.delete_column('assignments_assignmentgroup', 'course_id')
