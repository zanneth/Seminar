...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('assignments_comment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('assignment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['assignments.Assignment'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['assignments.Comment'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['core.UserProfile'])),
            ('body', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('assignments', ['Comment'])


    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table('assignments_comment')
    ...
    models = {
        ...
        'assignments.assignment': {
            ...
            'due': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 6, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'assignments.submission': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'points_earned': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
