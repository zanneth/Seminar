...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MaterialGroup'
        db.create_table('materials_materialgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(related_name='material_groups', to=orm['core.Course'])),
        ))
        db.send_create_signal('materials', ['MaterialGroup'])
        ...
        db.create_table('materials_material', (
            ...
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='materials', to=orm['materials.MaterialGroup'])),
    ...
    def backwards(self, orm):
        # Deleting model 'MaterialGroup'
        db.delete_table('materials_materialgroup')
    ...
    models = {
        ...
        'materials.material': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'materials'", 'to': "orm['materials.MaterialGroup']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'visible': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        'materials.materialgroup': {
            'Meta': {'object_name': 'MaterialGroup'},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'material_groups'", 'to': "orm['core.Course']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '1024'})
        }
    }
