...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Material.url'
        db.add_column('materials_material', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Material.file'
        db.alter_column('materials_material', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Material.url'
        db.delete_column('materials_material', 'url')


        # Changing field 'Material.file'
        db.alter_column('materials_material', 'file', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100))
