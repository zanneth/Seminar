...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.default_course'
        db.add_column('core_userprofile', 'default_course',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Course'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.default_course'
        db.delete_column('core_userprofile', 'default_course_id')
