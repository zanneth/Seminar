...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsItem.course'
        db.add_column('news_newsitem', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='news_items', to=orm['core.Course']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsItem.course'
        db.delete_column('news_newsitem', 'course_id')
    ...
    models = {
        ...
        'news.newsitem': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'news_items'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['core.UserProfile']"}),
            'body': ('django.db.models.fields.TextField', [], {}),
            'body_html': ('django.db.models.fields.TextField', [], {}),
            'course': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'news_items'", 'to': "orm['core.Course']"}),
