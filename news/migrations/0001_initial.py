...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('news_newsitem', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='news_items', null=True, on_delete=models.SET_NULL, to=orm['core.UserProfile'])),
